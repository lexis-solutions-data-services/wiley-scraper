"""
Example: How to call the wiley-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/wiley-scraper
...
def run_actor():
    """Run the wiley-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/wiley-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.wiley.com/en-ie/search?term=golf"}],
            "maxItems": 10,
